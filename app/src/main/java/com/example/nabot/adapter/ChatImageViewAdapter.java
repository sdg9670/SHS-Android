...
public class ChatImageViewAdapter extends PagerAdapter {
    private Context mContext = null;
    ImageView imageView;
    int chat_id=0;
    List<String>  filepath=null;
    public ChatImageViewAdapter(Context context) {
        mContext = context;

    }

    public void imageViewAdapterDown(List<String> filepath , int chat_id){
